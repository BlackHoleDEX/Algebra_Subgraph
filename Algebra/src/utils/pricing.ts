...
const WMatic_ADDRESS = '0xa65be6d7de4a82cc9638fb3dbf8e68b7f2e757ab'
const USDC_WMatic_03_POOL = '0x694e5dfcbcf3b98b036db9b298fe68eda29cd1db'

// token where amounts should contribute to tracked volume and liquidity
// usually tokens that many tokens are paired with s
export let WHITELIST_TOKENS: string[] = [
  '0xa65be6d7de4a82cc9638fb3dbf8e68b7f2e757ab', // WMATIC
  '0xac96dbabb398ee0c49660049590a6e5527ae581f', // USDC
