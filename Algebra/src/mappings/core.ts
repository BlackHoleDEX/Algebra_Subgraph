...
export function handleSwap(event: SwapEvent): void {
 ...
 if (amount0.lt(ZERO_BD)) {
   ...
   amount0withoutFee = amount0.times(BigDecimal.fromString('1000000').minus(pool.fee.toBigDecimal())).div(BigDecimal.fromString('1000000'))
   amount0Abs = amount0
 } 

 let amount1Abs = amount1
 let amount1withoutFee = amount1
 if (amount1.lt(ZERO_BD)) {
   ...
   communityFeeAmount = communityFeeAmount.times(BigDecimal.fromString("1"))  
   amount1Abs = amount1
   amount1withoutFee = amount1.times(BigDecimal.fromString('1000000').minus(pool.fee.toBigDecimal())).div(BigDecimal.fromString('1000000'))
 }
  ...
  pool.sqrtPrice = event.params.price
  pool.totalValueLockedToken0 = pool.totalValueLockedToken0.plus(amount0withoutFee)
  pool.totalValueLockedToken1 = pool.totalValueLockedToken1.plus(amount1withoutFee)
  ...
  token1.totalValueLocked = token1.totalValueLocked.plus(amount1withoutFee)
