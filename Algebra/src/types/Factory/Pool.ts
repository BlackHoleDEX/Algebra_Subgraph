...
export class Pool__getCommunityFeePendingResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pool__getPluginFeePendingResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pool__globalStateResult {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class Pool__safelyGetStateOfAMMResult {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class Pool__swapWithPaymentInAdvanceResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pool extends ethereum.SmartContract {
  ...
  getCommunityFeePending(): Pool__getCommunityFeePendingResult {
    let result = super.call(
    ...
    return new Pool__getCommunityFeePendingResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getCommunityFeePending(): ethereum.CallResult<
    Pool__getCommunityFeePendingResult
  > {
    let result = super.tryCall(
      "getCommunityFeePending",
      "getCommunityFeePending():(uint128,uint128)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__getCommunityFeePendingResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getPluginFeePending(): Pool__getPluginFeePendingResult {
    let result = super.call(
      "getPluginFeePending",
    ...
    return new Pool__getPluginFeePendingResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPluginFeePending(): ethereum.CallResult<
    Pool__getPluginFeePendingResult
  > {
    let result = super.tryCall(
      "getPluginFeePending",
      "getPluginFeePending():(uint128,uint128)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__getPluginFeePendingResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  globalState(): Pool__globalStateResult {
    let result = super.call(
      "globalState",
    ...
    return new Pool__globalStateResult(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_globalState(): ethereum.CallResult<Pool__globalStateResult> {
    let result = super.tryCall(
      "globalState",
      "globalState():(uint160,int24,uint16,uint8,uint16,bool)",
      []
  ...
  safelyGetStateOfAMM(): Pool__safelyGetStateOfAMMResult {
    let result = super.call(
      "safelyGetStateOfAMM",
    ...
    return new Pool__safelyGetStateOfAMMResult(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_safelyGetStateOfAMM(): ethereum.CallResult<
    Pool__safelyGetStateOfAMMResult
  > {
    let result = super.tryCall(
      "safelyGetStateOfAMM",
      "safelyGetStateOfAMM():(uint160,int24,uint16,uint8,uint128,int24,int24)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__safelyGetStateOfAMMResult(
        value[0].toBigInt(),
        value[1].toI32(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  swapWithPaymentInAdvance(
    ...
    limitSqrtPrice: BigInt,
    data: Bytes
  ): Pool__swapWithPaymentInAdvanceResult {
    let result = super.call(
      "swapWithPaymentInAdvance",
    ...
    return new Pool__swapWithPaymentInAdvanceResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swapWithPaymentInAdvance(
    ...
    limitSqrtPrice: BigInt,
    data: Bytes
  ): ethereum.CallResult<Pool__swapWithPaymentInAdvanceResult> {
    let result = super.tryCall(
      "swapWithPaymentInAdvance",
      "swapWithPaymentInAdvance(address,address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__swapWithPaymentInAdvanceResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
