...
import type {
  ...
  AlgebraInterfaceMulticallInterface,
} from "../../../contracts/lens/AlgebraInterfaceMulticall";
...
type AlgebraInterfaceMulticallConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AlgebraInterfaceMulticallConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AlgebraInterfaceMulticall__factory extends ContractFactory {
  constructor(...args: AlgebraInterfaceMulticallConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): AlgebraInterfaceMulticall__factory {
    return super.connect(runner) as AlgebraInterfaceMulticall__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AlgebraInterfaceMulticallInterface {
    return new Interface(_abi) as AlgebraInterfaceMulticallInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AlgebraInterfaceMulticall;
  }
}
