...
export interface CustomPluginInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface CustomPlugin extends BaseContract {
  connect(runner?: ContractRunner | null): CustomPlugin;
