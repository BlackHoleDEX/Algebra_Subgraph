...
export interface TestMulticallInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "functionThatRevertsSilently",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "functionThatRevertsWithCustomError",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "functionThatRevertsWithPanic",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TestMulticall extends BaseContract {
  ...
  functionThatRevertsSilently: TypedContractMethod<[], [void], "view">;

  functionThatRevertsWithCustomError: TypedContractMethod<[], [void], "view">;
  ...
  functionThatRevertsWithPanic: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "functionThatRevertsSilently"
  ): TypedContractMethod<[], [void], "view">;
  getFunction(
    nameOrSignature: "functionThatRevertsWithCustomError"
  ): TypedContractMethod<[], [void], "view">;
  getFunction(
    nameOrSignature: "functionThatRevertsWithError"
  ): TypedContractMethod<[error: string], [void], "view">;
  getFunction(
    nameOrSignature: "functionThatRevertsWithPanic"
