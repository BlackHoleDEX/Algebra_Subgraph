...
import type {
  SlidingFeePlugin,
  SlidingFeePluginInterface,
} from "../../../contracts/plugins/SlidingFeePlugin";
...
export class SlidingFeePlugin__factory {
  static readonly abi = _abi;
  static createInterface(): SlidingFeePluginInterface {
    return new Interface(_abi) as SlidingFeePluginInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SlidingFeePlugin {
    return new Contract(address, _abi, runner) as unknown as SlidingFeePlugin;
  }
}
