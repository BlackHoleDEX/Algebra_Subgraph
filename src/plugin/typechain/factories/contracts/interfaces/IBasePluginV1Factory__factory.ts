...
import type {
  ...
  IBasePluginV1FactoryInterface,
} from "../../../contracts/interfaces/IBasePluginV1Factory";
...
export class IBasePluginV1Factory__factory {
  static readonly abi = _abi;
  static createInterface(): IBasePluginV1FactoryInterface {
    return new Interface(_abi) as IBasePluginV1FactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IBasePluginV1Factory;
  }
}
