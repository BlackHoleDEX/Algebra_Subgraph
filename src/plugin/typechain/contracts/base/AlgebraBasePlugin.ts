...
export interface AlgebraBasePluginInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AlgebraBasePlugin extends BaseContract {
  connect(runner?: ContractRunner | null): AlgebraBasePlugin;
  waitForDeployment(): Promise<this>;

  interface: AlgebraBasePluginInterface;
