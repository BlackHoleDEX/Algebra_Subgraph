...
export interface IBasePluginInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "afterFlash"
      | "afterInitialize"
...
export interface IBasePlugin extends BaseContract {
  connect(runner?: ContractRunner | null): IBasePlugin;
  waitForDeployment(): Promise<this>;

  interface: IBasePluginInterface;
