...
export declare namespace MockTimeAlgebraBasePluginV1 {
...
export interface MockTimeAlgebraBasePluginV1Interface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [MockTimeAlgebraBasePluginV1.UpdateParamsStruct[]]
  ): string;
  encodeFunctionData(
...
export interface MockTimeAlgebraBasePluginV1 extends BaseContract {
  connect(runner?: ContractRunner | null): MockTimeAlgebraBasePluginV1;
  waitForDeployment(): Promise<this>;

  interface: MockTimeAlgebraBasePluginV1Interface;
  ...
  batchUpdate: TypedContractMethod<
    [params: MockTimeAlgebraBasePluginV1.UpdateParamsStruct[]],
    [void],
    "nonpayable"
  >;
