...
export interface VolatilityOracleTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "advanceTime"
      | "batchUpdate"
...
export interface VolatilityOracleTest extends BaseContract {
  connect(runner?: ContractRunner | null): VolatilityOracleTest;
  waitForDeployment(): Promise<this>;

  interface: VolatilityOracleTestInterface;
