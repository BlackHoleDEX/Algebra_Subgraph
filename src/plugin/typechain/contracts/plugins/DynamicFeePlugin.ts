...
export interface DynamicFeePluginInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface DynamicFeePlugin extends BaseContract {
  connect(runner?: ContractRunner | null): DynamicFeePlugin;
  waitForDeployment(): Promise<this>;

  interface: DynamicFeePluginInterface;
