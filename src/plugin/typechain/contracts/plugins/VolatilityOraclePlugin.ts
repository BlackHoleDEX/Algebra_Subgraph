...
export interface VolatilityOraclePluginInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface VolatilityOraclePlugin extends BaseContract {
  connect(runner?: ContractRunner | null): VolatilityOraclePlugin;
  waitForDeployment(): Promise<this>;

  interface: VolatilityOraclePluginInterface;
