...
export class FarmingFailed extends ethereum.Event {
  get params(): FarmingFailed__Params {
    return new FarmingFailed__Params(this);
  }
}

export class FarmingFailed__Params {
  _event: FarmingFailed;

  constructor(event: FarmingFailed) {
    this._event = event;
  }
...
export class NonfungiblePositionManager extends ethereum.SmartContract {
  ...
  NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE(): Bytes {
    let result = super.call(
      "NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE",
      "NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE():(bytes32)",
      []
    );
  ...
  try_NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE(): ethereum.CallResult<
    Bytes
  > {
    let result = super.tryCall(
      "NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE",
  ...
  farmingApprovals(tokenId: BigInt): Address {
    let result = super.call(
      "farmingApprovals",
      "farmingApprovals(uint256):(address)",
  ...
  try_farmingApprovals(tokenId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "farmingApprovals",
      "farmingApprovals(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
  ...
  positions(tokenId: BigInt): NonfungiblePositionManager__positionsResult {
    let result = super.call(
      "positions",
      "positions(uint256):(uint88,address,address,address,address,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
  ...
  tokenFarmedIn(tokenId: BigInt): Address {
    let result = super.call(
      "tokenFarmedIn",
      "tokenFarmedIn(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
  ...
  try_tokenFarmedIn(tokenId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "tokenFarmedIn",
      "tokenFarmedIn(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
...
export class ApproveForFarmingCall extends ethereum.Call {
  get inputs(): ApproveForFarmingCall__Inputs {
    return new ApproveForFarmingCall__Inputs(this);
  }

  get outputs(): ApproveForFarmingCall__Outputs {
    return new ApproveForFarmingCall__Outputs(this);
  }
}

export class ApproveForFarmingCall__Inputs {
  _call: ApproveForFarmingCall;

  constructor(call: ApproveForFarmingCall) {
    this._call = call;
  }
  ...
  get farmingAddress(): Address {
    return this._call.inputValues[2].value.toAddress();
  }
}

export class ApproveForFarmingCall__Outputs {
  _call: ApproveForFarmingCall;
...
export class SetFarmingCenterCall extends ethereum.Call {
  get inputs(): SetFarmingCenterCall__Inputs {
    return new SetFarmingCenterCall__Inputs(this);
  }

  get outputs(): SetFarmingCenterCall__Outputs {
    return new SetFarmingCenterCall__Outputs(this);
  }
}

export class SetFarmingCenterCall__Inputs {
  _call: SetFarmingCenterCall;

  constructor(call: SetFarmingCenterCall) {
    this._call = call;
  }

  get newFarmingCenter(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetFarmingCenterCall__Outputs {
  _call: SetFarmingCenterCall;
...
export class SwitchFarmingStatusCall extends ethereum.Call {
  get inputs(): SwitchFarmingStatusCall__Inputs {
    return new SwitchFarmingStatusCall__Inputs(this);
  }

  get outputs(): SwitchFarmingStatusCall__Outputs {
    return new SwitchFarmingStatusCall__Outputs(this);
  }
}

export class SwitchFarmingStatusCall__Inputs {
  _call: SwitchFarmingStatusCall;

  constructor(call: SwitchFarmingStatusCall) {
    this._call = call;
  }
  ...
  get toActive(): boolean {
    return this._call.inputValues[1].value.toBoolean();
  }
}

export class SwitchFarmingStatusCall__Outputs {
  _call: SwitchFarmingStatusCall;
